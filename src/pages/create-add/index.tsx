      ...
      if (
        ...
        try {
          ...
          const rewardClaimPeriodInSeconds =
            parseInt(data.rewardClaimPeriod) * 24 * 60 * 60; // days to seconds
          ...
          <div>
            ...
            <div className="relative">
              ...
              <div className="absolute right-3 top-9 text-gray-500 cursor-help group">
                ...
                <div className="absolute bottom-full right-0 mb-2 w-64 p-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                  ...
                  https://hey.xyz/posts/1zxw5wgrn11377k8vx0). The post ID will
            ...
            <div className="relative">
              ...
              <div className="absolute right-3 top-9 text-gray-500 cursor-help group">
                ...
                <div className="absolute bottom-full right-0 mb-2 w-64 p-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                  The contract will allocate 90% of this amount for rewards and
                  10% for display fees. Rewards per action = (90% of pool) /
                  number of slots.
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              <CustomizedInput
                ...
                onChange={(e) =>
                  setData({ ...data, minFollowers: e.target.value })
                }
              />
              <CustomizedInput
                label="Maximum Slots"
              ...
              <div className="relative">
                ...
                <div className="absolute right-3 top-9 text-gray-500 cursor-help group">
                  ...
                  <div className="absolute bottom-full right-0 mb-2 w-48 p-2 bg-gray-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                    How long the campaign will be active for users to
                    participate
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <button
                  ...
                  onClick={() =>
                    setData({ ...data, actionType: ActionType.QUOTE })
                  }
                >
                  Quote
                </button>
            ...
            {data.actionType === ActionType.QUOTE && (
              <div className="mt-4">
                <CustomizedInput
                  ...
                  onChange={(e) =>
                    setData({ ...data, quoteText: e.target.value })
                  }
                />
                <p className="text-sm text-gray-500 mt-1 italic">
                  This text will be suggested to users when they quote your
                  post.
                </p>
              </div>
            )}
