    ...
    <>
      <div className="flex items-center pb-2 mb-4">
        <input
          ...
          placeholder="Search"
          className="w-full p-2 rounded-md border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {trendingItems.map((item, index) => (
          <span
            key={index}
            className="px-4 py-1 border rounded-full text-sm text-gray-700 dark:text-gray-300 border-gray-300 dark:border-gray-700 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700"
          >
            {item}
          </span>
        ))}
      ...
      <div>
        ...
        <div className="space-y-2">
          {defaultCampaigns.map((campaign) => (
            <div key={campaign.id} className="bg-gray-50 dark:bg-gray-800">
